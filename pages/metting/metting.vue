<template>
	<view class="page">
		...
		<uni-popup ref="popupPlace" type="diglog">
			<uni-popup-dialog mode="input" title="编辑文字内容" placeholder="输入会议地点" :value="place"></uni-popup-dialog>
		</uni-popup>
		<uni-popup ref="popupDesc" type="diglog">
			<uni-popup-dialog mode="input" title="编辑文字内容" placeholder="输入会议内容" :value="desc"></uni-popup-dialog>
		</uni-popup>
	</view>
</template>
